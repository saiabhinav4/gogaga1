...
// /*Agent Count*/
// $all_agent = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM `agents` WHERE `recycle`='0'"));
// $wait_agent = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM `agents` WHERE `recycle`='0' and `app_status`='0'"));
// $app_agent = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM `agents` WHERE `recycle`='0' and `app_status`='1'"));
// $rev_agent = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM `agents` WHERE `recycle`='0' and `app_status`='2'"));

// /*Lead Count*/
// $all_leads = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM `leads`"));
// $submitted_lead = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM `leads` WHERE `status`='0'"));
?>
        ...
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><?php echo date('d-M-Y') ?></li>
                                ...
                                <div class="card card-h-100">
                                    ...
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            <div class="col-6">
                                                <span class="text-muted mb-3 lh-1 d-block text-truncate">Itineraries <br> Submitted</span>
                                                <h4 class="mb-3">
                            ...
                            <div class="col-xl-3 col-md-6">
                                ...
                                <div class="card card-h-100">
                                    ...
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            <div class="col-6">
                                                <span class="text-muted mb-3 lh-1 d-block text-truncate">Itineraries <br> Confirmed</span>
                                                <h4 class="mb-3">
                            ...
                            <div class="col-xl-3 col-md-6">
                                ...
                                <div class="card card-h-100">
                                    ...
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            <div class="col-6">
                                                <span class="text-muted mb-3 lh-1 d-block text-truncate">Volume <br> Quoted</span>
                                                <h4 class="mb-3">
                            ...
                            <div class="col-xl-3 col-md-6">
                                ...
                                <div class="card card-h-100">
                                    ...
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            <div class="col-6">
                                                <span class="text-muted mb-3 lh-1 d-block text-truncate">Volume <br> Confirmed</span>
                                                <h4 class="mb-3">
                                ...
                                <div class="card card-h-100">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex flex-wrap align-items-center mb-4">
                                            <h5 class="card-title me-2">Sales By Product</h5>
                                            <div class="ms-auto">
                                                <div>
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-sm align-self-center">
                                                <div class="mt-4 mt-sm-0">
                                                    <div>
                                                        <p class="mb-2"><i class="mdi mdi-circle align-middle font-size-10 me-2 text-success"></i>International</p>
                                                        <h6><span class="text-muted font-size-14 fw-normal">INR 400025.32</span></h6>
                                                    </div>
    
                                                    <div class="mt-4 pt-2">
                                                        <p class="mb-2"><i class="mdi mdi-circle align-middle font-size-10 me-2 text-primary"></i> Domestic</p>
                                                        <h6><span class="text-muted font-size-14 fw-normal">INR 122123.64</span></h6>
                                                    </div>
    
                                                    <div class="mt-4 pt-2">
                                                        <p class="mb-2"><i class="mdi mdi-circle align-middle font-size-10 me-2 text-info"></i> Cruise</p>
                                                        <h6><span class="text-muted font-size-14 fw-normal">INR 255263.09</span></h6>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-xl-8">
                                        ...
                                        <div class="card card-h-100">
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex flex-wrap align-items-center mb-4">
                                                    <h5 class="card-title me-2">Partner Activation Rate</h5>
                                                    <div class="ms-auto">
                                                    ...
                                                    <div class="col-sm align-self-center">
                                                        <div class="mt-4 mt-sm-0">
                                                            ...
                                                            <div class="row g-0">
                                                                <div class="col-6">
                                                                    <div>
                                                                        <p class="mb-2 text-muted text-uppercase font-size-11">Land Cost</p>
                                                                        <p class="fw-medium">INR 1122632</p>
                                                                    </div>
                                                                </div>
                                                                <div class="col-6">
                                                                    <div>
                                                                        <p class="mb-2 text-muted text-uppercase font-size-11">Flight Cost</p>
                                                                        <p class="fw-medium">INR 112924</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                        ...
                        <div class="row">
                            <div class="col-xl-8">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex flex-wrap align-items-center mb-4">
                                            <h5 class="card-title me-2">Monthly Volume Conversion</h5>
                                            <div class="ms-auto">
                                                <div>
                                                    <button type="button" class="btn btn-soft-primary btn-sm">
                                                        ALL
