                                                ...
                                                <div class="d-flex align-items-start mt-3 mt-sm-0">
                                                    <div class="flex-shrink-0">
                                                        <div class="avatar-xl me-3">
                                                            <img src="<?php echo $agent_data['photoPath']; ?>" alt="" class="img-fluid rounded-circle d-block">
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="tab-pane active" id="overview" role="tabpanel">
                                        <div class="card">
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $agent_data['maritalStatus']; ?></td>
                                                
                                            </tr>

                                            <tr>
                                                <td>District</td>
                                                <td><?php echo $agent_data['district']; ?></td>
                                                
                                            </tr>

                                            <tr>
                                                <td>Year of Operanting</td>
                                                <td><?php echo $agent_data['yearOfExperience']; ?></td>
                                                
                                            </tr>

                                            <tr>
                                                <td>Trade Name</td>
                                                <td><?php echo $agent_data['tradeName']; ?></td>
                                                
                                            </tr>

                                            <tr>
                                                <td>Trade Type</td>
                                                <td><?php echo $agent_data['tradeType']; ?></td>
                                                
                                            </tr>

                                            <tr>
                                                <td>Trade Address</td>
                                                <td><?php echo $agent_data['tradeAddress']; ?></td>
...
Bank Address :</h5>
                                                            ...
                                                            <div class="col-xl">
                                                                <div class="text-muted">
                                                                    <p class="mb-2"><?php echo $bank_data['bankAddress']; ?><br/>
                                                            </p>
