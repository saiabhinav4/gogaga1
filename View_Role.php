...
<div class="container ">
    <div class="row card">
        ...
        <div class="form-group col-lg-6 mb-5 mt-3">
            ...
            <input type="text" class="form-control" id="roleName" placeholder="Role Name" readonly>
        </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-check me-4">
                            <input class="form-check-input" type="checkbox" id="createLeads" value="create" checked disabled>
                    ...
                    <td>
                        <div class="form-check me-4">
                            <input class="form-check-input" type="checkbox" id="editLeads" value="edit" disabled>
