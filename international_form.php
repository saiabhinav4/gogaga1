...
<div class="row">
    <center>
        <h3>International Reservation Form</h3>
    </center>
                ...
                <div class="mt-3 mt-lg-0">
                    ...
                    <div class="mb-5 border p-3  mt-4 shadow-sm m-3">
                        ...
                        <select class="form-control" data-trigger name="Reservation _Type" id="choices-multiple-default" placeholder="Reservation Type" multiple>
                            ...
                            <option value="Choice 8">Visa</option>
                        </select>
...
<div class="card">
    ...
    <div class="card-body">
        ...
        <table class="table table-bordered">
            ...
            <tr>
                <td>Land price after loading</td>
                <td><input type="text" class="form-control"></td>
                <td><input type="text" class="form-control"></td>
            </tr>
            ...
            <tr class="bg-soft-secondary">
                <td >Land cost including service tax</td>
                <td></td>
                <td><input type="text" class="form-control"></td>
            </tr>
            <tr>
            ...
            <tr>
                <td>Cruise cost(Vendor Price)</td>
                <td><input type="text" class="form-control"></td>
                <td><input type="text" class="form-control"></td>
            </tr>
            <tr>
            ...
            <tr>
                <td>Package cost per person </td>
                <td><input type="text" class="form-control"></td>
                <td><input type="text" class="form-control"></td>
            </tr>
            <tr >
                <td colspan="2"> Package cost per Adult</td>
                <td><input type="text" class="form-control"></td>
            </tr>
            <tr>
                <td colspan="2">Package cost per Child</td>
                <td><input type="text" class="form-control"></td>
            </tr>
            ...
            <tr>
                <td>Total Land cost for all pax (Excl Flights)</td>
                <td colspan="2"><input type="text" class="form-control"></td>

            </tr>
            <tr>
                <td>Total Flight cost for all pax</td>
                <td colspan="2"><input type="text" class="form-control"></td>
...
<!-- end card -->
        ...
        <script>
            $(document).ready(function() {
                // Function to add Supplier and Cost Details container
                function addSupplierContainer() {
                    var clonedContainer = $("#supplier_cont").clone(true);
                    clonedContainer.removeClass("hidden"); // Remove the 'hidden' class to show the cloned container
                    clonedContainer.appendTo("#containerForSupplier"); // Change this selector to the desired location

                    // Add remove button click event
                    clonedContainer.find(".removeSupplierContainer").click(function() {
                        clonedContainer.remove(); // Remove the clicked container
                        updateRemoveButtons();
                    });
                }
                ...
                function updateRemoveButtons() {
                    var containers = $("#containerForSupplier").children();
                    if (containers.length > 1) {
                        containers.find(".removeSupplierContainer").show();
                    } else {
                        containers.find(".removeSupplierContainer").hide();
                    }
                }

                // Add Supplier and Cost Details container when the button is clicked
                $("#addSupplierContainer").click(function() {
                    addSupplierContainer();
                    updateRemoveButtons();
                });

                // Initial functionality for the initial container
                $("#supplier_cont").find(".removeSupplierContainer").click(function() {
                    $("#supplier_cont").remove(); // Remove the initial container
                    updateRemoveButtons();
                });

                // Add any additional initial functionality here
        ...
        <div id='supplier_cont'>
            <h4 class="m-3">Supplier and Cost Details</h4>
            <div class="col-lg-12" id="visa">

                <!-- Supplier Details Container End  -->
                ...
                <div class="card p-3">
                    <div class="card-header">
                        ...
                        <div class='text-end m-2'>
                            <button class="btn btn-danger removeSupplierContainer">Remove</button>
                        </div>
                    </div>



                    <div class="" id="supplierAccordion" class="accordion mt-3 card-body">
                        <div class="card-body">
                            ...
                            <div class="">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            <label for="choices-multiple-remove-button" class="form-label font-size-13 text-muted">Mail Draft</label>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            <label for="choices-multiple-remove-button" class="form-label font-size-13 text-muted">Destination</label>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            <label for="choices-multiple-remove-button" class="form-label font-size-13 text-muted">Supplier Type</label>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            <label for="choices-multiple-remove-button" class="form-label font-size-13 text-muted">Supplier Company Name</label>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            <label for="choices-multiple-remove-button" class="form-label font-size-13 text-muted">Supplier Contact Person</label>
                                            <input type="text" class="form-control" name="service_start_date" id="service_start_date" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <!-- If Consolidated Details Container Start -->



                        <h4 class="card-title mt-3 mb-3">In Case of Consolidated Cost</h4>
                        <div class="form-check form-switch text-end">
                            <input class="form-check-input" type="checkbox" role="switch" id="toggleButton" checked>

                        </div>

                        <div class="row p-3" id='consolidated-cont'>

                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <label for="choices-multiple-remove-button" class="form-label font-size-13 text-muted">Cost Received in</label>
                                    <select name="" class='form-control' id="">
                                        <option value="" selected>Select</option>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <label for="choices-multiple-remove-button" class="form-label font-size-13 text-muted">Total Cost Received</label>
                                    <input type="text" class="form-control" name="supplier_name" id="supplier_name" />
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <label for="choices-multiple-remove-button" class="form-label font-size-13 text-muted">Currency Rate Considered</label>
                                    <input type="text" class="form-control" name="supplier_name" id="supplier_name" />
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <label for="choices-multiple-remove-button" class="form-label font-size-13 text-muted">Total Cost Considered in INR</label>
                                    <input type="text" class="form-control" name="service_start_date" id="service_start_date" disabled />
                                </div>
                            </div>

                            <div class="col-lg-12">
                                <label for="choices-multiple-remove-button" class="form-label font-size-13 text-muted">Cost Bifuration</label>
                                <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                            </div>
                        </div>
                    </div>

                    <!-- If Consolidated Details Container End -->


                    <!-- Hotel Details Container Start -->


                    <div class="container mt-5 hidden" id='hotel-cont'>

                        <div id="containerHolder" class="mt-3">
                            <div class="card mt-3">
                                <div class="card-header">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                <label for="city" class="form-label font-size-13 text-muted">City</label>
                                                <input type="text" class="form-control" name="city" id="city" />
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                <label for="hotel" class="form-label font-size-13 text-muted">Hotel</label>
                                                <input type="text" class="form-control" name="hotel" id="hotel" />
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                <label for="room_standard" class="form-label font-size-13 text-muted">Room Standard</label>
                                                <input type="text" class="form-control" name="room_standard" id="room_standard" />
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                <label for="cost" class="form-label font-size-13 text-muted">Cost If any (Bifurcated)</label>
                        ...
                        <div class='text-center'>
                            <button id="addHotelContainer" class="btn btn-primary mt-3">Add Hotel</button>
                        </div>

                    </div>

                    <!--Hotels Container End -->





                    <!-- Tours And Transfers Container Start -->


                    <div class="container mt-2 hidden" id='tour-cont'>
                        <div id="toursHolder" class="mt-3">
                            <div class="card mt-3">
                                <div class="card-header">
                                    <h4 class="card-title">Tours and Transfers</h4>
                                </div>
                                <div class="card-body">
                                    <div class="row p-3">
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                <label for="tour_name" class="form-label font-size-13 text-muted">Tour Name</label>
                                                <input type="text" class="form-control" name="tour_name" id="tour_name" />
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                <label for="tour_day" class="form-label font-size-13 text-muted">Tour Day</label>
                                                <input type="text" class="form-control" name="tour_day" id="tour_day" />
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                <label for="currency" class="form-label font-size-13 text-muted">Currency Considered</label>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                <label for="tour_cost" class="form-label font-size-13 text-muted">Cost If any (Bifurcated)</label>
                                                <input type="text" class="form-control" name="tour_cost" id="tour_cost" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class='text-center'>
                            <button id="addTours" class="btn btn-primary mt-3">Add Tours</button>
                        </div>
                    </div>

                    <!-- Tours And Transfers Container End -->


                    <p class='m-3 text-danger'>Note: Any price difference in mail and cost sheet - Conversation between you and supplier to be attached here</p>
                ...
                <div class='text-center m-3'>
                    <button id="addSupplierContainer" class="btn btn-primary mt-3">Add Supplier and Cost Details</button>
                </div>
        ...
        <div id="containerForSupplier"></div>




        <!-- Hotel Script Code Start -->
        <script>
            document.getElementById('addHotelContainer').addEventListener('click', function(event) {
                event.preventDefault();
            });
            ...
            function addContainer() {
                ...
                containerCount++;
                const containerId = `container_${containerCount}`;
                const containerHtml = `
                <div id="${containerId}" class="card mt-3">
                    <div class="card-header">
                        <h4 class="card-title">Hotel Details</h4>
                        <button class="btn btn-danger btn-sm float-end" onclick="removeContainer('${containerId}')">Remove</button>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <label for="${containerId}_city" class="form-label font-size-13 text-muted">City</label>
                                    <input type="text" class="form-control" name="${containerId}_city" id="${containerId}_city" />
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <label for="${containerId}_hotel" class="form-label font-size-13 text-muted">Hotel</label>
                                    <input type="text" class="form-control" name="${containerId}_hotel" id="${containerId}_hotel" />
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <label for="${containerId}_room_standard" class="form-label font-size-13 text-muted">Room Standard</label>
                                    <input type="text" class="form-control" name="${containerId}_room_standard" id="${containerId}_room_standard" />
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <label for="${containerId}_cost" class="form-label font-size-13 text-muted">Cost If any (Bifurcated)</label>
                                    <input type="text" class="form-control" name="${containerId}_cost" id="${containerId}_cost" />
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            `;
                document.getElementById('containerHolder').insertAdjacentHTML('beforeend', containerHtml);
            }
            ...
            document.getElementById('addHotelContainer').addEventListener('click', addContainer);
        </script>


        <!-- Hotel Script Code End -->





        <!-- Tours And Transfers Script Code Start -->
        <script>
            document.getElementById('addTours').addEventListener('click', function(event) {
                event.preventDefault();
            });
            ...
            function addTours() {
                toursCount++;
                const toursId = `tours_${toursCount}`;
                const toursHtml = `
                <div id="${toursId}" class="card mt-3">
                    <div class="card-header">
                        <h4 class="card-title">Tours and Transfers</h4>
                        <button class="btn btn-danger btn-sm float-end" onclick="removeTours('${toursId}')">Remove</button>
                    </div>
                    <div class="card-body">
                        <div class="row p-3">
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <label for="${toursId}_tour_name" class="form-label font-size-13 text-muted">Tour Name</label>
                                    <input type="text" class="form-control" name="${toursId}_tour_name" id="${toursId}_tour_name" />
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <label for="${toursId}_tour_day" class="form-label font-size-13 text-muted">Tour Day</label>
                                    <input type="text" class="form-control" name="${toursId}_tour_day" id="${toursId}_tour_day" />
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <label for="${toursId}_currency" class="form-label font-size-13 text-muted">Currency Considered</label>
                                    <select class="form-control" name="${toursId}_currency" id="${toursId}_currency">
                                        <option value="" selected>Select</option>
                                        <option value="USD">USD</option>
                                        <option value="EUR">EUR</option>
                                        <option value="THB">THB</option>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <label for="${toursId}_tour_cost" class="form-label font-size-13 text-muted">Cost If any (Bifurcated)</label>
                                    <input type="text" class="form-control" name="${toursId}_tour_cost" id="${toursId}_tour_cost" />
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            `;
                document.getElementById('toursHolder').insertAdjacentHTML('beforeend', toursHtml);
            }

            function removeTours(toursId) {
                const toursToRemove = document.getElementById(toursId);
                if (toursToRemove) {
                    toursToRemove.remove();
                }
            }

            document.getElementById('addTours').addEventListener('click', addTours);
        </script>


        <!-- Tours And Transfers Script Code  End -->
        ...
        <script>
            ...
            const container1 = document.getElementById('hotel-cont');
            const container2 = document.getElementById('tour-cont');
            const container3 = document.getElementById('consolidated-cont');
            let isHidden = true;
...
<div class="col-lg-12" id="visa">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">Visa Details</h4>


        </div>
        <div class="" id="visaAccordion" class="accordion mt-3 card-body">
            <div class="card-body">
                ...
                <div class="">
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="mb-3">
                                <label for="choices-multiple-remove-button" class="form-label font-size-13 text-muted">Visa Type</label>
                                <select name="" class='form-control' id="">
                                    <option value="">Regular</option>
                                    <option value="">Online</option>
                                    <option value="">On Arrival</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <div class="mb-3">
                                <label for="choices-multiple-remove-button" class="form-label font-size-13 text-muted">Passport Holder</label>
                                <input type="text" class="form-control" name="vehicle_type" id="vehicle_type" />
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="mb-3">
                                <label for="choices-multiple-remove-button" class="form-label font-size-13 text-muted">Cost Considered Per Person</label>
                                <input type="number" class="form-control" name="seats" id="seats" />
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <div class="mb-3">
                                <label for="choices-multiple-remove-button" class="form-label font-size-13 text-muted">Visa Cost(All Pax)</label>
                                <input type="number" class="form-control" name="service_start_date" id="service_start_date" />
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <div class="mb-3">
                                <label for="choices-multiple-remove-button" class="form-label font-size-13 text-muted">Total Visa Cost considered in cost sheet</label>
                                <input type="text" class="form-control" name="service_end_date" id="service_end_date" disabled />
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="col-lg-12" id="visa">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">TCS Details</h4>
                ...
                <div class="card-body">
                    ...
                    <div class="">
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    <label for="choices-multiple-remove-button" class="form-label font-size-13 text-muted">Total TCS (%)</label>
                                    <input type="text" class="form-control" name="supplier_name" id="supplier_name" />
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    <label for="choices-multiple-remove-button" class="form-label font-size-13 text-muted">Total TCS Amount</label>
                                    <input type="text" class="form-control" name="supplier_name" id="supplier_name" />
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    <label for="choices-multiple-remove-button" class="form-label font-size-13 text-muted">Is Customer paying TCS?</label>
                                    <select name="" id="" class='form-control'>
                                        <option value="" selected>Select</option>
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    <label for="choices-multiple-remove-button" class="form-label font-size-13 text-muted">Does Customer require Invoice?</label>
                                    <select name="" id="" class='form-control'>
                                        <option value="" selected>Select</option>
                                        <option value="yes">Yes</option>
                                        <option value="no">No</option>
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    <label for="choices-multiple-remove-button" class="form-label font-size-13 text-muted">Is the customer's pan card linked with Aadhaar?</label>
                                    <select name="" id="" class='form-control'>
                                        <option value="" selected>Select</option>
                                        <option value="yes">Yes</option>
                                        <option value="n9">No</option>
                                    </select>
                                </div>
                            </div>
                        </div>
        ...
        <!-- Inclusions And Exclusions Section Start -->
        ...
        <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                <input type="text" class="form-control" id="add_inclusion">
                                <div class='text-center text-center'>
                                    <button class='btn btn-soft-secondary m-3' id='inc'>Add</button>
                                </div>
                                <div id='inclusion_data'></div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                ...
                                <input type="text" class="form-control" id="add_exclusion">

                                <div class='text-center text-center'>
                                    <button class='btn btn-soft-secondary m-3' id='exc'>Add</button>
                                </div>

                                <div id='exclusion_data'></div>
            ...
            <script>
                document.getElementById('inc').addEventListener('click', function(event) {
                    event.preventDefault();
                    let inclusion = document.getElementById('add_inclusion');
                    let s = inclusion.value;
                    let inclusion_container = document.getElementById('inclusion_data');
                ...
                document.getElementById('exc').addEventListener('click', function(event) {
                    event.preventDefault();
                    let exclusion = document.getElementById('add_exclusion');
                    let s = exclusion.value
                    let exclusion_container = document.getElementById('exclusion_data');
                ...
                document.getElementById('International_form_submit').addEventListener('click', function(event) {
                    event.preventDefault();
                });
            </script>

            <div class='text-center m-3'>
                <input type="submit" class='btn btn-primary' id='International_form_submit'>
            </div>
